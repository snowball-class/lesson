...
//import snowball.lesson.dto.lesson.GetMemberLessonDto;
...
//    @Override
//    public List<LessonResponse> getEventLessonList(long eventId) {
...
//    // comment : 추후 리뷰테이블 추가되면 정렬 추가할 것
//    @Override
//    public List<LessonResponse> getLessonList(int categoryId) {
//        return jdbcTemplate.query(
...
//    // comment : 추후 리뷰테이블 추가되면 정렬 추가할 것
//    @Override
//    public List<LessonResponse> getSearchLesson(String keyword){
...
//
//    @Override
//    public LessonDetailsResponse findById(long id) {
//        try {
...
//    }
//
//    private RowMapper<LessonDetailsResponse> lessonDetailMapper() {
//        return (rs, rowNum) -> {
//            LessonDetailsResponse lesson = new LessonDetailsResponse();
//            lesson.setLessonId(rs.getLong("lesson_id"));
//            lesson.setTitle(rs.getString("title"));
//            lesson.setTutor(rs.getString("tutor"));
//            lesson.setCategoryId(rs.getInt("category_id"));
...
//            lesson.setThumbnailUrl(getThumbUrl(thumbId));  // 이미지 URL
//
...
//    }
//
//    private RowMapper<LessonResponse> lessonListMapper() {
//        return (rs, rowNum) -> {
